...
This app uses MongoDB Atlas as its database to store the application's data. To establish a connection between MongoDB and the application I install the MongoDB driver for Node.js. 

...
const getStaticProps = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Hayaa:Heyheyyou1997%40%40@atlascluster.k4pqhv7.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
